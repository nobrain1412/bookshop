                                ...
                                <table class="table table-bordered text-center mt-2" id="dataTable" width="100%"
                                    ...
                                    @foreach($posts as $data)
                                        <tr class="old">
                                            ...
                                            <td>
                                                <input type="checkbox" class="child-checkbox" value="{{$data->id}}"
                                                       name="ids[]">
                                            </td>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" value="{{ $data->status }}" name="status"
                                                           data-item-id="{{ $data->id }}"
                                                           class="switch1 switch-status switchery-small" {{ $data->status == 1 ? 'checked' : '' }} />
                                                </div>
                                            </td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                               href="{{route('post.edit',$data->id)}}">Sửa</a></li>
                                                        <li>
                                                            <a href="{{ route('post.destroy', ['id' => $data->id]) }}"
                                                               class="dropdown-item
                                    show_confirm" data-name="Xoá thẻ a">Xoá </a>
                                                    ...
                                                    <form action="{{ route('post.destroy', ['id' => $data->id]) }}"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="dataTable_info" role="status" aria-live="polite">
                                    Hiển thị {{ $posts->firstItem() }} đến {{ $posts->lastItem() }}
                                    của {{ $posts->total() }} mục
                                </div>
                            </div>
